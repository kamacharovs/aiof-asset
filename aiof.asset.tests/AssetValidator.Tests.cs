...
namespace aiof.asset.tests
{
    ...
    public class AssetValidatorTests
    {
        ...
        [Theory]
        [MemberData(nameof(Helper.ValidNames), MemberType = typeof(Helper))]
        public async Task AssetStockDto_Validation_Name_IsValid(string name)
        {
            var dto = Helper.RandomAssetStockDto();

            dto.Name = name;

            Assert.True((await _stockDtoValidator.ValidateAsync(dto)).IsValid);
        }
        [Theory]
        [MemberData(nameof(Helper.InvalidNames), MemberType = typeof(Helper))]
        public async Task AssetStockDto_Validation_Name_IsInvalid(string name)
        {
            var dto = Helper.RandomAssetStockDto();

            dto.Name = name;

            Assert.False((await _stockDtoValidator.ValidateAsync(dto)).IsValid);
        }

        [Theory]
        [MemberData(nameof(Helper.ValidTypeNames), MemberType = typeof(Helper))]
        public async Task AssetStockDto_Validation_TypeName_IsValid(string typeName)
        {
            var dto = Helper.RandomAssetStockDto();
        ...
        [Theory]
        [MemberData(nameof(Helper.InvalidTypeNames), MemberType = typeof(Helper))]
        public async Task AssetStockDto_Validation_TypeName_IsInvalid(string typeName)
        {
            var dto = Helper.RandomAssetStockDto();
        ...
        public async Task AssetStockDto_Validation_TickerSymbol_IsValid(string tickerSymbol)
        {
            var dto = Helper.RandomAssetStockDto();
        ...
        public async Task AssetStockDto_Validation_TickerSymbol_IsInvalid(string tickerSymbol)
        {
            var dto = Helper.RandomAssetStockDto();
        ...
        public async Task AssetStockDto_Validation_Shares_IsValid(double shares)
        {
            var dto = Helper.RandomAssetStockDto();
        ...
        public async Task AssetStockDto_Validation_Shares_IsInvalid(double shares)
        {
            var dto = Helper.RandomAssetStockDto();
        ...
        public async Task AssetStockDto_Validation_ExpenseRatio_IsValid(double expenseRatio)
        {
            var dto = Helper.RandomAssetStockDto();
        ...
        public async Task AssetStockDto_Validation_ExpenseRatio_IsInvalid(double expenseRatio)
        {
            var dto = Helper.RandomAssetStockDto();
        ...
        [Theory]
        [MemberData(nameof(Helper.ValidExpenseRatios), MemberType = typeof(Helper))]
        public async Task AssetStockDto_Validation_DividendYield_IsValid(double dividendYield)
        {
            var dto = Helper.RandomAssetStockDto();
        ...
        [Theory]
        [MemberData(nameof(Helper.InvalidExpenseRatios), MemberType = typeof(Helper))]
        public async Task AssetStockDto_Validation_DividendYield_IsInvalid(double dividendYield)
        {
            var dto = Helper.RandomAssetStockDto();
